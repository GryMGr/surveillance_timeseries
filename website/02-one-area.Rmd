...
d[,`Cases per 100.000 Pop`:=Cases/Population*100000]
...
q <- q + scale_y_continuous("", labels=scales::format_format(big.mark = ".", decimal.mark = ",", scientific = FALSE))
q <- q + scale_fill_brewer("Year",palette="Set1")
